...
class Gui(tk.Tk):
    ...
    # lists that are used to design the user interface.
    ...
    def __init__(self, controller):
        ...
        # This method will be explained in the future.
    ...
    def _make_sub_frame(self):
        ...
        self.values_to_insert = ['Initial condition:', 'Number of Cells (nx):', 'x_max:', 'Boundry value at x0:',
    ...
    def _show_special_entries_and_save_choice(self, e):
        ...
        if e == self.Equation_opts[1]:  # Schrodinger equation.
        ...
        elif e == self.Equation_opts[2]:  # One way wave wave equation.
            self.MyButton.grid_forget()
        ...
        elif e == self.Equation_opts[0]:  # Heat wave equation.
    ...
    def _create_enter_button(self):
        ...
        """
        self.MyButton = tk.Button(self.sub_frm, text='Solve Equation', command=self._click_solve_equation)
    ...
    def _make_drop_down_list(self):
        ...
        """
        self.title3 = tk.Label(self.main_frm, text='Choose equation: ', font=('Helvatical bold', 10))
    ...
    def _create_initial_func_drop_down_list(self):
        ...
        self.title4 = tk.Label(self.sub_frm, text='Choose initial condition form: ', font=('Helvatical bold', 10))
    ...
    def _create_potential_type_dropdown_list(self):
        ...
        self.title5 = tk.Label(self.sub_frm, text='Choose potential type: ', font=('Helvatical bold', 10))
